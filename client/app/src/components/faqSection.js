...
function FaqSection() {
  ...
  const faqs = [
    {
      id: 1,
      question: t('faq.q1', currentLanguage),
      answer: t('faq.a1', currentLanguage),
      category: 'processing'
    },
    {
      id: 2,
      question: t('faq.q2', currentLanguage),
      answer: t('faq.a2', currentLanguage),
      category: 'approval'
    },
    {
      id: 3,
      question: t('faq.q3', currentLanguage),
      answer: t('faq.a3', currentLanguage),
      category: 'documents'
    },
    {
      id: 4,
      question: '비자 수수료는 얼마인가요?',
      answer: '비자 종류에 따라 다르며, 관광비자는 89,000원, 상용비자는 149,000원부터 시작합니다.',
      category: 'cost'
    },
    {
      id: 5,
      question: '비자 신청이 거절될 수 있나요?',
      answer: '저희 서비스의 승인률은 99.8%로 매우 높습니다. 만약 거절될 경우 전액 환불해드립니다.',
      category: 'approval'
    },
    {
      id: 6,
      question: '긴급 비자 발급이 가능한가요?',
      answer: '네, 긴급 처리 서비스를 통해 12시간 내 발급이 가능합니다. 추가 수수료가 발생합니다.',
      category: 'urgent'
    }
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-20 animate-fade-in">
          ...
          <h2 className="text-5xl font-bold text-[#003366] mb-6">
            <span className="text-gradient">{t('faq.title', currentLanguage)}</span>
          </h2>
          <p className="text-gray-600 text-xl max-w-3xl mx-auto">
            고객님들이 자주 묻는 질문들을 모았습니다. 더 궁금한 점이 있으시면 언제든 문의해주세요.
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto mb-12 animate-fade-in" style={{animationDelay: '0.2s'}}>
          <div className="relative">
            ...
            <Input
              type="text"
              placeholder={t('faq.search', currentLanguage)}
              value={searchTerm}
              ...
              <Card className="floating-card gradient-card border-0 overflow-hidden hover-lift">
                ...
                >
                  <div className="flex items-center justify-between">
                    <CardTitle className="text-lg text-[#003366] pr-4">
                      {faq.question}
                    </CardTitle>
        ...
        <div className="text-center mt-16 animate-fade-in" style={{animationDelay: '1s'}}>
          <div className="glass-card inline-block p-8 rounded-2xl">
            ...
            <p className="text-gray-600 mb-6">
              전문 상담사가 실시간으로 답변해드립니다. 언제든 편하게 문의해주세요.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="gradient-accent text-white px-6 py-3 rounded-xl hover:scale-105 transition-all duration-300 font-semibold">
                실시간 채팅 상담
              </button>
