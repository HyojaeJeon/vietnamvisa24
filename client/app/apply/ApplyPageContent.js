...
export default function ApplyPageContent() {
  ...
  const renderStepComponent = () => {
    switch (currentStep) {
      ...
      case 5:
        return <ReviewStep formData={formData} onNext={handleApplicationSubmit} onPrevious={handlePrevious} onEdit={handleEdit} isSubmitting={isSubmitting} updateFormData={updateFormData} />;
      case 6:
