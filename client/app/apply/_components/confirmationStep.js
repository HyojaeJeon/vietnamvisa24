...
const ConfirmationStep = ({ formData, applicationId }) => {
    ...
    try {
      ...
      try {
        await sendEmail(
          ...
          `베트남 비자 접수증_${applicationId || "TEMP"}.pdf`,
      ...
      try {
        ...
        alert(
          "PDF 생성 중 오류가 발생했습니다. 브라우저 인쇄 기능을 사용해주세요.",
        );
      }
    }
  };
  ...
  const generateTextBasedPDF = async () => {
    ...
    y += lineHeight;
    pdf.text(
      `Visa Type: ${getVisaTypeLabel(formData.visaType)}`,
      leftMargin,
      y,
    );
    y += lineHeight;
    pdf.text(
      `Processing Type: ${getProcessingTypeLabel(formData.processingType)}`,
      leftMargin,
      y,
    );
    y += lineHeight * 2;
    ...
    <div className="space-y-8">
      ...
      >
        ...
        <div className="pb-8 mb-8 text-center border-b-2 border-blue-600">
          <div className="mb-4">
            <h1 className="mb-3 text-4xl font-bold text-blue-800">
              베트남 비자 신청 접수증
            </h1>
            <p className="text-xl text-gray-600 font-medium">
              Vietnam Visa Application Receipt
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 gap-10">
          ...
          <div className="p-6 bg-blue-50 rounded-lg border border-blue-200">
            <h3 className="mb-5 text-xl font-bold text-blue-800 border-b border-blue-300 pb-2">
              신청 정보
            </h3>
          ...
          <div className="p-6 bg-green-50 rounded-lg border border-green-200">
            <h3 className="mb-5 text-xl font-bold text-green-800 border-b border-green-300 pb-2">
              개인 정보
            </h3>
            <div className="space-y-3">
              <div className="flex">
        ...
        <div className="p-6 bg-orange-50 rounded-lg border border-orange-200">
          <h3 className="mb-5 text-xl font-bold text-orange-800 border-b border-orange-300 pb-2">
            여권 정보
          </h3>
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-3">
              <div className="flex">
                ...
                <span className="font-bold">
                  {formData.personalInfo?.passportNumber || "N/A"}
                </span>
              </div>
              <div className="flex">
                <span className="font-medium text-gray-700 w-32">
            ...
            <div className="space-y-3">
              <div className="flex">
                ...
                <span>
                  {formData.personalInfo?.passportExpiryDate || "N/A"}
                </span>
              </div>
              <div className="flex">
                <span className="font-medium text-gray-700 w-32">
                ...
                <span>
                  {formData.personalInfo?.passportIssuePlace || "대한민국"}
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="p-6 bg-purple-50 rounded-lg border border-purple-200">
          <h3 className="mb-5 text-xl font-bold text-purple-800 border-b border-purple-300 pb-2">
            여행 정보
          </h3>
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-3">
              <div className="flex">
                ...
                <span className="font-bold">
                  {formData.travelInfo?.entryDate || "N/A"}
                </span>
              </div>
              <div className="flex">
            ...
            <div className="space-y-3">
              <div className="flex">
                ...
                <span className="font-bold">
                  {getAirportLabel(formData.travelInfo?.entryPort)}
                </span>
              </div>
              <div className="flex">
                <span className="font-medium text-gray-700 w-32">
        ...
        <div className="p-6 bg-gradient-to-r from-green-100 to-emerald-100 rounded-lg border-2 border-green-300">
          <h3 className="mb-5 text-xl font-bold text-green-800 border-b border-green-400 pb-2">
            비용 정보
          </h3>
        ...
        <div className="p-6 bg-gray-50 rounded-lg border border-gray-200">
          <h3 className="mb-5 text-xl font-bold text-gray-800 border-b border-gray-300 pb-2">
            연락처 정보
          </h3>
        ...
        <div className="pt-6 text-sm text-gray-600 border-t-2 border-gray-300">
          <div className="grid grid-cols-1 gap-2">
            <p>※ 본 접수증은 신청 접수 확인용입니다.</p>
            <p>
              ※ 처리 상황은 이메일로 안내드리며, 신청번호로 진행 상황을 확인하실
              수 있습니다.
            </p>
            <p>
              ※ 베트남 입국 시 여권과 승인된 비자를 함께 지참하시기 바랍니다.
            </p>
            <p>
              ※ 문의사항이 있으시면 위 연락처로 신청번호와 함께 연락주시기
              바랍니다.
            </p>
          </div>
        </div>
          ...
          <div className="text-center">
            <div className="relative p-8 overflow-hidden text-white bg-gradient-to-r from-green-600 to-emerald-700 rounded-2xl">
              ...
              <div className="relative z-10">
                ...
                <div className="mb-4 text-3xl font-bold tracking-wider">
                  {applicationId}
                </div>
                <Button
          ...
          <div className="p-6 rounded-lg bg-yellow-50">
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span>
                  <strong>신청번호를 안전한 곳에 보관하세요.</strong> 진행 상황
                  조회 시 필요합니다.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 mt-2 bg-yellow-500 rounded-full"></div>
                <span>
                  <strong>이메일과 SMS로 진행 상황을 안내합니다.</strong>{" "}
                  스팸함도 확인해주세요.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 mt-2 bg-yellow-500 rounded-full"></div>
                <span>
                  <strong>추가 서류 요청 시 즉시 제출해주세요.</strong> 지연 시
                  처리가 늦어질 수 있습니다.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 mt-2 bg-yellow-500 rounded-full"></div>
                <span>
                  <strong>비자 발급 후 여권과 함께 지참하세요.</strong> 베트남
                  입국 시 제시가 필요합니다.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-2 h-2 mt-2 bg-yellow-500 rounded-full"></div>
                <span>
                  <strong>문의사항은 고객센터로 연락하세요.</strong> 신청번호를
                  준비해주세요.
                </span>
              </li>
            </ul>
          ...
          onClick={() => {
            ...
            if (navigator.share) {
              ...
              navigator.clipboard.writeText(
                `베트남 비자 신청 완료! 신청번호: ${applicationId}`,
              );
