...
import { Globe, Plane, Car, Clock, ArrowRight, CheckCircle, Star, Zap, Shield, Users } from "lucide-react";
      ...
      <Card className="overflow-hidden border-0 shadow-2xl bg-gradient-to-br from-white via-slate-50 to-blue-50/30">
        <CardHeader className="relative pb-8 text-white bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600">
          ...
          <div className="relative z-10 text-center">
            ...
            <CardTitle className="mb-3 text-4xl font-bold">베트남 비자 신청</CardTitle>
            <p className="text-xl text-blue-100">간편하고 안전한 온라인 비자 신청 서비스를 경험해보세요</p>
          </div>
        </CardHeader>
        ...
        <CardContent className="p-8 space-y-10">
          ...
          <div className="space-y-6">
            <div className="text-center">
              <h3 className="mb-2 text-2xl font-bold text-gray-800">서비스 선택</h3>
              <p className="text-lg text-gray-600">원하시는 서비스와 기본정보를 선택해주세요</p>
            </div>
                        ...
                        <div className="flex flex-col items-center text-center space-y-3">
                          ...
                          <div>
                            <div className="flex items-center justify-center gap-2 mb-1">
                              <span className="text-xl font-bold text-gray-800">{service.icon === Globe ? "🌐" : service.icon === Plane ? "✈️" : "🚗"}</span>
                              <h5 className="text-lg font-bold text-gray-800">{service.title}</h5>
                            </div>
                            <p className="mb-2 text-sm font-semibold text-blue-600">{service.subtitle}</p>
          ...
          {formData.serviceType === "e_visa" && (
            <div className="space-y-6">
              ...
              <RadioGroup
                ...
                onValueChange={(value) => handleServiceChange("visaDurationType", value)}
                    ...
                    <div key={duration.id} className="relative">
                      ...
                      >
                        ...
                        <div className="text-center space-y-3">
                          <div>
                            <h5 className="mb-1 text-xl font-bold text-gray-800">{duration.title}</h5>
                            <p className="mb-2 text-sm font-semibold text-emerald-600">{duration.subtitle}</p>
                            <p className="mb-3 text-sm text-gray-600">{duration.description}</p>
                            <p className="text-lg font-bold text-blue-600">{duration.price}</p>
                          </div>
                        </div>
                      </Label>
                    </div>
          ...
          {formData.serviceType && (
            <div className="space-y-6">
              ...
              <RadioGroup
                ...
                onValueChange={(value) => handleServiceChange("processingType", value)}
                className="grid grid-cols-1 gap-4 md:grid-cols-3"
              >
                    ...
                    <div key={processing.id} className="relative">
                      ...
                      >
                        <div className="flex flex-col items-center text-center space-y-3">
                          ...
                          <div>
                            <h5 className="mb-1 text-lg font-bold text-gray-800">{processing.title}</h5>
                            <p className="mb-2 text-sm font-semibold text-purple-600">{processing.subtitle}</p>
                            <p className="mb-2 text-sm text-gray-600">{processing.description}</p>
          ...
          {isValid && (
            <div className="p-6 text-center bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl">
              <h4 className="mb-2 text-lg font-bold text-gray-800">예상 결제 금액</h4>
