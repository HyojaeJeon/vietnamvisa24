...
export default function PricingModal({
  ...
  useEffect(() => {
    if (type === "edit" && price) {
      setFormData({
        ...
        sellingPriceUsd: price.sellingPriceUsd || 0,
  ...
  const handleInputChange = (e) => {
    ...
    setFormData((prev) => ({
      ...prev,
      [name]: inputType === "checkbox" ? checked : inputType === "number" ? parseFloat(value) || 0 : value,
    }));
  ...
  const getModalTitle = () => {
    ...
    const service = priceType === "evisa" ? "E-VISA" : priceType === "visarun" ? "Visa Run" : "Fast Track";
            ...
            <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              ...
              <div className="space-y-4">
                  ...
                  <>
                    <div>
                      ...
                      <select
                        ...
                        className={`mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 ${errors.type ? "border-red-300" : ""}`}
                      >
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700">처리 시간</label>
                      <select
                        name="processingTime"
                        value={formData.processingTime}
                        onChange={handleInputChange}
                        className={`mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 ${errors.processingTime ? "border-red-300" : ""}`}
                      >
                        <option value="">선택해주세요</option>
                  ...
                  <>
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        className={`mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 ${errors.visaType ? "border-red-300" : ""}`}
                      >
                        <option value="">선택해주세요</option>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        min="1"
                        max="10"
                        className={`mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 ${errors.peopleCount ? "border-red-300" : ""}`}
                      />
                  ...
                  <>
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        className={`mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 ${errors.serviceType ? "border-red-300" : ""}`}
                      >
                        <option value="">선택해주세요</option>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        className={`mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 ${errors.airport ? "border-red-300" : ""}`}
                      >
                        <option value="">선택해주세요</option>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700">USD 판매가</label>
                    <input
                      type="number"
                      ...
                      step="0.01"
                      min="0"
                      className={`mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 ${errors.sellingPriceUSD ? "border-red-300" : ""}`}
                    />
                    {errors.sellingPriceUSD && <p className="mt-1 text-sm text-red-600">{errors.sellingPriceUSD}</p>}
                  </div>

                  <div>
                    <label className="block text-sm font-medium text-gray-700">USD 마진</label>
                    <input
                      type="number"
                      name="marginUSD"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700">VND 판매가</label>
                    <input
                      type="number"
                      ...
                      step="1000"
                      min="0"
                      className={`mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 ${errors.sellingPriceVND ? "border-red-300" : ""}`}
                    />
                    {errors.sellingPriceVND && <p className="mt-1 text-sm text-red-600">{errors.sellingPriceVND}</p>}
                  </div>

                  <div>
                    <label className="block text-sm font-medium text-gray-700">VND 마진</label>
                    <input
                      type="number"
                      name="marginVND"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700">KRW 판매가</label>
                    <input
                      type="number"
                      ...
                      step="1000"
                      min="0"
                      className={`mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 ${errors.sellingPriceKRW ? "border-red-300" : ""}`}
                    />
                    {errors.sellingPriceKRW && <p className="mt-1 text-sm text-red-600">{errors.sellingPriceKRW}</p>}
                  </div>

                  <div>
                    <label className="block text-sm font-medium text-gray-700">KRW 마진</label>
                    <input
                      type="number"
                      name="marginKRW"
