...
export default function SocketTestPage() {
  ...
  } = useSocket(testUserId, testToken);
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-2">
            <p><strong>상태:</strong> {isConnected ? '연결됨' : '연결 안됨'}</p>
            <p><strong>사용자 ID:</strong> {testUserId}</p>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <Button 
                onClick={() => handleStatusUpdate('DOCUMENT_REVIEW')}
                variant="outline"
                size="sm"
              >
                서류 검토
              ...
              <Button 
                onClick={() => handleStatusUpdate('SUBMITTED_TO_AUTHORITY')}
                variant="outline"
                size="sm"
              >
                기관 제출
              ...
              {notifications.map((notification) => (
                ...
                >
                  <div className="flex items-start justify-between">
                    ...
                    {!notification.isRead && (
                      <div className="w-2 h-2 bg-blue-500 rounded-full ml-3 mt-1" />
                    )}
                  </div>
                </div>
              ))}
